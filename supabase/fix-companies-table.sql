-- Fix Companies Table Setup
-- Run this if you're getting "column location does not exist" errors

-- First, drop any existing table and policies
...
-- Create the companies table with all required columns
CREATE TABLE companies (
  id UUID DEFAULT uuid_generate_v4() PRIMARY KEY,
  place_id TEXT UNIQUE,
  name TEXT NOT NULL,
  formatted_address TEXT,
  location TEXT, -- Combined location for display
  city TEXT,
  state TEXT,
  industry TEXT,
  phone TEXT,
...
-- Create RLS policies (simplified to avoid auth table references)
