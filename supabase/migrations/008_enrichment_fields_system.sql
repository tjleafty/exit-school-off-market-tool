...
CREATE TABLE public.enrichment_fields (
...
-- Create index for quick tier filtering
CREATE INDEX idx_enrichment_fields_tier ON public.enrichment_fields(tier);
CREATE INDEX idx_enrichment_fields_category ON public.enrichment_fields(field_category);
CREATE INDEX idx_enrichment_fields_sort ON public.enrichment_fields(sort_order);
...
-- Insert default field configurations based on ZoomInfo CSV structure
