        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg max-w-6xl w-full max-h-[90vh] overflow-hidden flex flex-col">
            <div className="p-6 border-b border-gray-200 flex justify-between items-center">
              <h3 className="text-xl font-semibold">Historical Companies</h3>
              <button
            ...
            <div className="p-6 overflow-y-auto flex-1">
              {historicalCompanies.length === 0 ? (
                <p className="text-gray-500 text-center py-8">No historical companies found</p>
              ) : (
                      ...
                      {historicalCompanies.map(company => (
                        <tr key={company.id} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <span className={`px-2 py-1 text-xs rounded ${company.is_enriched ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'}`}>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm">
                            ...
                            {!company.is_enriched && (
                              ...
                              >
                                {enrichingCompany === company.id ? 'Enriching...' : 'Enrich'}
                              </button>
                            )}
                          </td>
                        </tr>
